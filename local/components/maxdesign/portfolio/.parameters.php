...
if (class_exists('\Bitrix\Iblock\Elements\ElementPortfolioFiltersTable')) {
    ...
    while ($arData = $rsData -> fetch()) {
        $sefFilters[$arData["CODE"]] = "[" . $arData["CODE"] . "] " . $arData["NAME"];
    }
}
...
$arComponentParameters = [
	...
	"PARAMETERS" => [
		...
		"SEF_MODE" => [
            ...
            "filtered" => [
                "NAME" => 'Страница с ЧПУ фильтрами',
                "DEFAULT" => "#SMART_FILTER_PATH#/",
                "VARIABLES" => ["SMART_FILTER_PATH"],
            ],
			"search" => [
