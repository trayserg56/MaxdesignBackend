...
?><!--
<div class="society giao">
	<div class="header-container">
		<div class="sulugi-t">
			<h1>Дизайн интерьера гостиницы, апарт-отеля</h1>
			<div class="sulugi-btn-group">
				 <a class="btn btn-promo3" data-reveal-id="zakaz" >Оставить заявку</a> <a class="btn btn-promo3" href="/local/templates/maxdesign/files/gost.pdf">Пример проекта</a>
			</div>
		</div>
	</div>
</div>
